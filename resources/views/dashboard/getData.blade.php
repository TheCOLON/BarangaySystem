            ...
            <form>
                ...
                <div class="data"> 
                    ...
                    <div class="data1">
                        ...
                        @if ($latestData)
                            <p class="p2"><b>THIS IS TO CERTIFY THAT</b> <span class = "underline"> {{$latestData->name}} </span>, a resident of Purok {{$latestData->purok}} Imbatug, <br> 
                            ...
                            <p class="p4">That as per the record of this office, he has never been charged with nor convicted of <br>
                            crimes, violations of existing laws.</p>

                            <p class="p5">That this <b>Clearance</b> is being issued upon the request of the above-named <br>
                            person for  <span class="underline-person"> </span>any legal purpose/s and intent that may serve his <br> best.</p>
